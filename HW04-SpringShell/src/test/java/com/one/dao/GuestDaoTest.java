...
class GuestDaoTest {
    ...
    void getGuestById() {
        ...
        assertEquals(guest, guestDao.getGuestById(guest.getId()).get());
    }

    @Test
    @DisplayName("should get guest by firstName")
    void getGuestByFirstName() {
        guestDao.saveGuest(guest);

        assertEquals(guest, guestDao.getUserByFirstName(guest.getFirstName()).get());
    }
